...
# 设置账户
w3.eth.defaultAccount = '0x0f120e3b86d41ee600f32856ca76e9cd65342cec'  # 设置默认账户,owner地址
# 创建合约对象
...
def authSpenders(operator_address,user_address):
	# 调用函数授权新地址
	tx_hash = contract.functions.addSpender(user_address).transact({'from': operator_address})
	w3.eth.wait_for_transaction_receipt(tx_hash)
...
def authRecievers(operator_address,user_address):
	# 调用函数授权新地址
	tx_hash = contract.functions.addReceiver(user_address).transact({'from': operator_address})
	w3.eth.wait_for_transaction_receipt(tx_hash)
...
if __name__ == '__main__':
	...
	callUploadDate("0x85805Ae2052EEa616db6c1A08e19d326Dac756B6","b'16d5da432ffb92b7a1a403ebcd2252c1a17a1db943a2cf1f'")
	# end_time = time.time()
