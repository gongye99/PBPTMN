...
if not w3.is_connected():
    ...
    exit()
# 合约地址和ABI
contract_address = Web3.to_checksum_address("0x3d64edef586936b240668e201b464487619bbb34") # 替换为您的合约地址
contract_abi =[
	{
		"inputs": [],
...
# 设置账户
w3.eth.defaultAccount = '0xaf095b4d9261f6b31ddd5825fee8370461f2ad9c'  # 设置默认账户,owner地址
# 创建合约对象
...
if __name__ == '__main__':
	...
	callUploadDate("0x85805Ae2052EEa616db6c1A08e19d326Dac756B6","+45K2q1enusX3DYJUK5NfVZNYzcC/UJqmu6ucaig/Se7bLqTv5sUTqP7O2Y/LL+F7sr4mRDmoopN1HrhyPPwf+FMJVlgTn5u1OynLUPMz5CCBNNJRVyAfc5SA7WEmJwPA6Q==")
	end_time = time.time()
